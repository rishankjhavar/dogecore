...
var HDPrivateKey = dogecore.HDPrivateKey;
var HDPublicKey = dogecore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = dogecore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(dogecore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(dogecore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      dogecore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = dogecore.PublicKey.fromPoint;
      dogecore.PublicKey.fromPoint = function() {
        dogecore.PublicKey.fromPoint = unstubbed;
