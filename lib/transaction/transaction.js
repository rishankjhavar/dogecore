...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://dogecore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by dogecore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a dogecore Address object. The
 * same is true for `script`, which can be a string or a dogecore Script.
 *
