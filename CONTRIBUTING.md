Contributing to Dogecore
=======

We're working hard to make *dogecore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *dogecore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://labs.bitpay.com/c/dogecore (Support Forum)
- https://gitter.im/bitpay/dogecore (Development Chat)
...
These are some global design goals in dogecore that any change must adhere.
...
When possible, dogecore objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of Dogecore methods. For example, calling `JSON.stringify` on an Dogecore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'dogecore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the dogecore object.

DO:
```javascript
var dogecore = require('../');
var PublicKey = dogecore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add bitpay git@github.com:bitpay/dogecore.git
...
```
Finally go to [github.com/bitpay/dogecore](https://github.com/bitpay/dogecore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of dogecore.

If you have any questions feel free to post them to
[github.com/bitpay/dogecore/issues](https://github.com/bitpay/dogecore/issues).
